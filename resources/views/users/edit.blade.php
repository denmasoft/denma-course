	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						<form method="POST" action="{{route('usuarios.update', $user->pk) }}" accept-charset="UTF-8" class="form-horizontal" id="userForm">
							{{method_field('PATCH')}}
							{{ csrf_field() }}
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" name="name" id="name" placeholder="Nombre" class="col-xs-10 col-sm-5" value="{{$user->name}}"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" name="last_name" id="last_name" placeholder="Apellidos" class="col-xs-10 col-sm-5" value="{{$user->surname}}" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" name="dni" id="dni" placeholder="DNI/NIE" class="col-xs-10 col-sm-5" value="{{!$user->cif?$user->nif:$user->cif}}"/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="input-group">
											<input class="form-control date-picker" id="birth" name="birth" type="text" data-date-format="dd-mm-yyyy" value="{{$user->birth}}"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="input-group">
											<select name="hall" id="hall" class="chosen-select" data-placeholder="Seleccione ayuntamiento...">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" name="address" id="address" placeholder="Direccion" class="col-xs-10 col-sm-5" value="{{$user->address}}"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Codigo Postal</label>
									<div class="col-sm-6">
										<input type="number" name="postal_code" id="postal_code" placeholder="Codigo Postal" class="col-xs-10 col-sm-5" value="{{$user->zip}}"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Telefono</label>
									<div class="col-sm-6">
										<input type="number" name="phone" id="phone" maxlength=9 placeholder="Telefono" class="col-xs-10 col-sm-5" value="{{$user->telephone}}"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Otro Telefono</label>
									<div class="col-sm-6">
										<input type="number" name="other_phone" id="other_phone" maxlength=9 placeholder="Otro Telefono" class="col-xs-10 col-sm-5" value="{{$user->other_phone}}" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Correo Electronico</label>
									<div class="col-sm-6">
										<input type="email" name="email" id="email" placeholder="Correo electronico" value="{{$user->email}}" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								<div class="form-group">
										...
										<div class="input-group">
											<select name="studies" id="studies">
												...
												@foreach($grades as $grade)
													<option {{$user->study===$grade->ID?'selected':'' }} value="{{$grade->ID}}">{{$grade->description}}</option>
												@endforeach
											</select>
										</div>
									</div>
							...
							<div class="col-sm-6" id="specialtyC" style="display: {{$show}};">
								<div class="form-group">
										...
										<div class="input-group">
											<select name="specialty" id="specialty">
												@foreach($specialties as $specialty)
													<option {{$user_specialty===$specialty->ID?'selected':'' }} value="{{$specialty->ID}}">{{$specialty->description}}</option>
												@endforeach
											</select>
										</div>
									</div>
										...
										<div class="input-group">
											<select name="job_posts" id="job_posts">
												@foreach($jobPosts as $jobPost)
													<option {{$user->job_posts===$jobPost->id?'selected':'' }} value="{{$jobPost->id}}">{{$jobPost->nome}}</option>
												@endforeach
											</select>
											<input {{$user->job_posts===null?'checked':'' }} type="checkbox" id="no_experience" name="no_experience">NO tengo experiencia profesional
										</div>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="input-group">
											<input type="text" name="languages" id="languages" value="{{$user->languages}}" placeholder="Ingles avanzado..." />
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="input-group">
											<input type="text" name="computer_skills" id="computer_skills" value="{{$user->computer_skills}}" placeholder="Microsoft Access avanzado..." />
									...
									<div class="col-sm-6">
										<div class="input-group">
											<select name="posts" id="posts">
												@foreach($jobPosts as $jobPost)
													<option {{$user->posts===$jobPost->id?'selected':'' }} value="{{$jobPost->id}}">{{$jobPost->nome}}</option>
												@endforeach
											</select>
										</div>
									</div>
