...
@section('content')
	...
	@endif
	<form style="padding: 30px;" id="puestoForm" method="POST" action="{{route('puestos.update', $puesto->id) }}" accept-charset="UTF-8" class="form-group">
			{{method_field('PATCH')}}
			{{ csrf_field() }}
		<div class="row">
						...
						<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
							...
							<div role="group" aria-labelledby="__BVID__232__BV_label_" class="">
								<div role="group" class="input-group">								
									<input type="text" class="form-control" name="name" required value="{{ strtoupper($puesto->nombre) }}">
								</div>
							</div>
						</fieldset>
						<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
								...
								<div role="group" aria-labelledby="__BVID__232__BV_label_" class="">
									<div role="group" class="input-group">								
										<input type="text" class="form-control" name="name_gl" required value="{{ strtoupper($puesto->nome) }}">
									</div>
								</div>
						</fieldset>					
					</div>
