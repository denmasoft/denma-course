					...
					<div class="row">
						...
						<div class="col-md-6">								
							<label class="switch switch-label switch-primary">
								<input disabled="disabled" type="checkbox" name="puestos[]" value="{{$puesto->id}}" class="switch-input" {{ (count($curso->puestos->pluck('id')->toArray()) > 0) ? (in_array($puesto->id, $curso->puestos->pluck('id')->toArray()))? 'checked' : '' : ''}}>
								<span class="switch-slider" data-checked="✓" data-unchecked="✕"></span>										
							</label>
