...
@section('content')
	...
	@endif
	<form style="padding: 30px;" id="enterpriseForm" method="POST" novalidate action="{{url('/panel/boletin-ofertas')}}" accept-charset="UTF-8" class="form-horizontal">
		{{ csrf_field() }}
		<div class="row">
			...
			<div class="col-md-6">
					<div class="card">
						<div class="card-header">
							<div>
									{{__('newsletter.new_newsletter_label')}}
							</div>
						</div>
						<div class="card-body">
							...
							<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
									...
									<div role="group" aria-labelledby="__BVID__232__BV_label_" class="">
										<div role="group" class="input-group">								
												<input type="text" readonly class="form-control" name="publishedAt" id="publishedAt" required>
										</div>
									</div>
							</fieldset>
							<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
									...
									<div role="group" aria-labelledby="__BVID__232__BV_label_" class="">
										<div role="group" class="input-group">								
												<input type="text" class="form-control" name="publishedIn" id="publishedIn" required>
										</div>
									</div>
							</fieldset>	
							<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
