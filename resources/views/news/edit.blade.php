						...
						<div class="card">
							...
							<div class="card-body">
								...
								<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
									...
									<div role="group" aria-labelledby="__BVID__232__BV_label_" class="">
										<div role="group" class="input-group">
											<input type="text" class="form-control" name="antetitulo" required value="{{$noticia->antetitulo}}">
										</div>
									</div>
								</fieldset>
								...
								<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
									...
									<div role="group" aria-labelledby="__BVID__232__BV_label_" class="">
										<div role="group" class="input-group">
											<textarea class="form-control" name="entradilla" required>
												{{$noticia->entradilla}}
											</textarea>
										</div>
									</div>
								...
								<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
									...
									<div role="group" aria-labelledby="__BVID__232__BV_label_" class="">
										...
										<span class="input-group-text">
											...
											<input type="text" id="fecha_publicacion" name="fecha_publicacion" value="{{$noticia->fecha_publicacion}}" class="form-control" value="{{$noticia->fecha_publicacion}}">
										</div>
									</div>
								</fieldset>
								...
								<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
									...
									<div role="group" aria-labelledby="__BVID__232__BV_label_" class="">
										...
										<span class="input-group-text">
											...
											<input type="text" id="fecha_expiracion" name="fecha_expiracion" value="{{$noticia->fecha_expiracion}}" class="form-control" value="{{$noticia->fecha_expiracion}}">
										</div>
									</div>
								</fieldset>
								<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
