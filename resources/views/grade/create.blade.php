...
@section('content')
	...
	@endif
	<form style="padding: 30px;" id="gradeForm" method="POST" novalidate action="{{url('/panel/estudios')}}" accept-charset="UTF-8" class="form-horizontal">
		{{ csrf_field() }}
		<div class="row">
					...
					<div class="card">
						...
						<div class="card-body">
							<fieldset id="" role="group" aria-labelledby="__BVID__232__BV_label_" aria-describedby="__BVID__232__BV_description_" class="b-form-group form-group">
								<legend id="__BVID__232__BV_label_" class="col-form-label pt-0">{{__('grade.description')}}</legend>
